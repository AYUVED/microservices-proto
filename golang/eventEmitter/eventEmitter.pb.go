...
type CreateMailerEventRequest struct {
	...
	Data        []*EventDataMap `protobuf:"bytes,15,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (x *CreateMailerEventRequest) GetData() []*EventDataMap {
	if x != nil {
		return x.Data
	}
	return nil
...
func (*EventDataMap) ProtoMessage() {}

func (x *EventDataMap) ProtoReflect() protoreflect.Message {
	mi := &file_eventEmitter_eventEmitter_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EventDataMap.ProtoReflect.Descriptor instead.
func (*EventDataMap) Descriptor() ([]byte, []int) {
	return file_eventEmitter_eventEmitter_proto_rawDescGZIP(), []int{3}
}

func (x *EventDataMap) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *EventDataMap) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_eventEmitter_eventEmitter_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x63, 0x68, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x21, 0x0a, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x44,
	0x61, 0x74, 0x61, 0x4d, 0x61, 0x70, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x36, 0x0a, 0x0c,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x44, 0x61, 0x74, 0x61, 0x4d, 0x61, 0x70, 0x12, 0x12, 0x0a, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x22, 0x2b, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x61,
